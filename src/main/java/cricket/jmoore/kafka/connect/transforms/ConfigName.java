...
interface ConfigName {
    String SOURCE_SCHEMA_REGISTRY_URL = "source." + KafkaAvroSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG;
    String SOURCE_BASIC_AUTH_CREDENTIALS_SOURCE = "source." + KafkaAvroSerializerConfig.BASIC_AUTH_CREDENTIALS_SOURCE;
    String SOURCE_USER_INFO = "source." + KafkaAvroSerializerConfig.USER_INFO_CONFIG;
